...
my $mysqlslap = "mysqlslap -uroot -pabcU123456 -C --number-of-queries=102400 --concurrency=$concurrency --iterations=3 --query='call test.UP_TestSelect'|grep 'Average number of seconds'";
